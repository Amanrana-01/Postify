...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="footer-medium">
      <div className="footer-content">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          {/* Brand */}
          <div className="flex flex-col items-center md:items-start">
            <Link href="/" className="logo-medium mb-2">
              Postify
            </Link>
            <p className="text-sm text-gray-500 text-center md:text-left max-w-md">
              A beautiful blog platform inspired by Postify. 
        ...
        <div className="border-t border-gray-200 mt-8 pt-6 text-center">
          <p className="text-sm text-gray-500">
            © {currentYear} Postify Blog. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
